...
let AuthController = class AuthController {
    ...
    validateLogin(data, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.authService.validateLogin(data);
            return response.send(result);
        });
    }
    register(data, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.authService.registerUser(data);
            return response.send(result);
        });
    }
};
...
__decorate([
    (0, routing_controllers_1.Post)('/validate-login'),
